...
export default {
  ...
  methods: {
    ...
    /**
     * Menu active style, id is currently clicked sidebar element's id;
     * Menu active style, id is currently clicked sidebar element's id;
     * @param id
     */
    activeSidebar: function (id) {
      // id's sibling menu elements remove 'active' style, add 'active' to id;
      $("#" + id).siblings().removeClass("active");
      $("#" + id).siblings().find("li").removeClass("active");
      $("#" + id).addClass("active");

      // if id has super menu element, remove open active of the
      // super menu element's sibling and add open active to super menu element
